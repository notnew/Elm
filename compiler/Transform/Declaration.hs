    ...
    where
      ...
      go decls =
          case decls of
            ...
            Datatype name tvars ctors derivations : rest ->
                (:) (Datatype name tvars ctors derivations) <$> go rest

            TypeAlias name tvars alias derivations : rest ->
                (:) (TypeAlias name tvars alias derivations) <$> go rest
